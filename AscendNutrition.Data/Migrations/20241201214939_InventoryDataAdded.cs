...
{
    /// <inheritdoc />
    public partial class InventoryDataAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1b48c8b4-b7f6-4354-9463-7cb9e084ae9c"), "Sofia" },
                    { new Guid("c68295f6-b5bb-4224-8516-877b57858f58"), "Burgas" },
                    { new Guid("e098a6b8-60d9-4f30-91d6-85eab6e5274b"), "Varna" }
                });
        }
