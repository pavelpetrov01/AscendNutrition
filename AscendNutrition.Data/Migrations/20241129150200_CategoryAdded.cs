    ...
    public partial class CategoryAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Unique identifier for the categories"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "The name of the category"),
                    ParentCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "Identifier of a possible parent category")
                },
                constraints: table =>
                {
